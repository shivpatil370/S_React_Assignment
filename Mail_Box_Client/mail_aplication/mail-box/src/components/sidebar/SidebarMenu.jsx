...
const SidebarMenu = () => {
  ...
  <path d="M15.854.146a.5.5 0 0 1 .11.54l-5.819 14.547a.75.75 0 0 1-1.329.124l-3.178-4.995L.643 7.184a.75.75 0 0 1 .124-1.33L15.314.037a.5.5 0 0 1 .54.11ZM6.636 10.07l2.761 4.338L14.13 2.576zm6.787-8.201L1.591 6.602l4.339 2.76z"/>
                ...
                <NavLink to={"/sentmail"} style={{color:"black",textDecoration:"none"}}>Sent</NavLink>
                </li>
            <li style={{padding:"0.1rem",paddingTop:"0.3rem",paddingBottom:"0.3rem",paddingLeft:"1.4rem",display:"flex"}} className={styles.hvr}>
                <div className="me-2">
  ...
  <path d="M14 4.5V14a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h5.5zm-3 0A1.5 1.5 0 0 1 9.5 3V1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V4.5z"/>
                ...
                Draft</li>
            <li style={{padding:"0.1rem",paddingTop:"0.3rem",paddingBottom:"0.3rem",paddingLeft:"1.4rem",display:"flex",fontWeight:"bold"}} className={styles.hvr}>
            <div className="me-2">
